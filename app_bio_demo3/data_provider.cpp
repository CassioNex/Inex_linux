...
DataProvider::DataProvider(QObject *parent) : QObject(parent)
{
    ...
    /* Nao usaremos o timer para disparar a aquisição de imagem a cada 1 seg
    QObject::connect(&timer, &QTimer::timeout, this, &DataProvider::capture_img);
