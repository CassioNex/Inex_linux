/****************************************************************************
** Meta object code from reading C++ file 'data_provider.h'
**
...
#error "The header file 'data_provider.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 12), // "img_captured"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 8), // "uint8_t*"
QT_MOC_LITERAL(4, 36, 3), // "buf"
QT_MOC_LITERAL(5, 40, 11) // "handleTimer"

    },
    "DataProvider\0img_captured\0\0uint8_t*\0"
    "buf\0handleTimer"
};
...
void DataProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->img_captured((*reinterpret_cast< uint8_t*(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataProvider::img_captured)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DataProvider::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DataProvider.data,
      qt_meta_data_DataProvider,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void DataProvider::img_captured(uint8_t * _t1)
{
